...
- Enter Reflections: Replace the `ok done` in the **Reflections** section below, within this file. This workflow fails till you replace it with your impressions.
...
reducing CCN, making code more generic
